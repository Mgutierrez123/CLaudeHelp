...
Dieses Plugin unterstützt nun vollständig **Windows, macOS und Linux** für Claude Code. Alle Hooks und Skripte wurden für maximale Kompatibilität in Node.js neu geschrieben.
