...
| `memory` | drop entirely | Native harness memory (Claude Code auto-memory directories, Cursor memories, AGENTS.md conventions) plus ECC's instinct/continuous-learning-v2 system. The knowledge-graph server solved a 2024 problem harnesses have since absorbed. |
